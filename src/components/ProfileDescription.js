...
export default function ProfileDescription() {
  return (
    <div className="profile-container">
      ...
      <h3>
        I completed a full-stack web development bootcamp where I learned how to
        build web apps using tools like JavaScript, React, Ruby on Rails, and
        SQL. I enjoy solving problems, building things that are both useful and
        intuitive, and learning by doing.
      </h3>
      <h3>
